...
from file import search_file, search_file_regex, remake_dir, unzip, cd, rename_file, copy_file, remove_file
from pip import pip_clear, pip_install, pip_install_text, pip_freeze
