...
class Post(models.Model):
    ...
    section = models.ForeignKey('Section', models.PROTECT)

    title = models.CharField(max_length=90)
    slug = models.SlugField(unique=settings.PINAX_BLOG_SLUG_UNIQUE)
    author = models.ForeignKey(settings.AUTH_USER_MODEL, models.PROTECT, related_name='posts')
    ...
    primary_image = models.ForeignKey('Image', models.SET_NULL, blank=True, null=True, related_name="+")
...
class Revision(models.Model):
    ...
    post = models.ForeignKey(Post, models.PROTECT, related_name="revisions")
    ...
    author = models.ForeignKey(settings.AUTH_USER_MODEL, models.PROTECT, related_name="revisions")
...
class Image(models.Model):
    ...
    post = models.ForeignKey('Post', models.PROTECT, related_name="images")
...
class ReviewComment(models.Model):
    ...
    post = models.ForeignKey('Post', models.PROTECT, related_name="review_comments")
