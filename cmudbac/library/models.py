...
class Repository(models.Model):
    ...
    project_type = models.ForeignKey('ProjectType', models.PROTECT)
    source = models.ForeignKey('RepositorySource', models.PROTECT)
    latest_attempt = models.ForeignKey('Attempt', models.PROTECT, blank=True, null=True)
...
class Attempt(models.Model):
    ...
    repo = models.ForeignKey('Repository', models.PROTECT, blank=True, null=True)
    sha = models.CharField(max_length=200, null=True)
    size = models.IntegerField()
    database = models.ForeignKey('Database', models.PROTECT, blank=True, null=False)
    ...
    runtime = models.ForeignKey('Runtime', models.PROTECT)
...
class Field(models.Model):
    ...
    action = models.ForeignKey('Action', models.PROTECT, related_name='fields')
## CLASS

class Counter(models.Model):
    description = models.CharField(max_length = 200)
    count = models.IntegerField(default = 0)
    action = models.ForeignKey('Action', models.PROTECT)
## CLASS
...
class Query(models.Model):
    ...
    action = models.ForeignKey('Action', models.PROTECT, related_name='queries')
## CLASS

class Explain(models.Model):
    output = models.TextField()
    query = models.ForeignKey('Query', models.PROTECT, related_name='explains')
## CLASS

class QueryMetric(models.Model):
    name = models.CharField(max_length = 200)
    value = models.TextField()
    query = models.ForeignKey('Query', models.PROTECT, related_name='queryMetrics')
## CLASS
